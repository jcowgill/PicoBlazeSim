...
namespace JCowgill.PicoBlazeSim.Import
{
    ...
    public class AssemblyImporter
    {
        ...
        /// </summary>
        private readonly ImportErrorList errorList = new ImportErrorList();
        ...
        #region Public Constructors, Properties and Methods

        /// <summary>
        /// Gets the list of errors generated by this importer
        /// </summary>
        public ImportErrorList ErrorList
        {
        ...
        public Program Import(Processor processor, bool keepDebugInfo = true)
        {
            ...
            if (errorList.ErrorCount == 0)
            {
                ...
                try
                {
                    return builder.CreateProgram(processor, keepDebugInfo);
                }
                catch (ImportException e)
                {
                    // Add to error list
                    errorList.AddError(e.Message);
                }
            }
